...
-- No MySQL, para se conectar ao banco de dados após criá-lo, utilizamos o comando USE.
USE exemplo_db;
...
CREATE TABLE usuarios (
    id INT AUTO_INCREMENT PRIMARY KEY,     -- id será um campo auto-incrementável (INT), utilizado como chave primária
